 ...
 */
public class WalletCreateDirectory extends BaseTaggableObject
     ...
     */
    @Deprecated
    public WalletCreateDirectory(NetworkParameters params) {
     ...
     */
    @Deprecated
    public WalletCreateDirectory(Context context) {
    ...
    public WalletCreateDirectory(NetworkParameters params, KeyChainGroup keyChainGroup) {
        this(Context.getOrCreate(params), keyChainGroup);
    }

    private WalletCreateDirectory(Context context, KeyChainGroup keyChainGroup) {
